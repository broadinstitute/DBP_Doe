...
#batch_size=$3
#optimizer=$4
python FromScratch.py --training_source sourcedata --training_target targetdata --model_path model --number_of_epochs $1 --model_name $2 --batch_size $3 --optimizer $4 --learning_rate $5 --testing_source 18_C1_all.tif --testing_target 18_C1_all_masks.tif --output_directory output --source_path 070721_Slide2_Animal1_all.tif
